// Function called whenever user tap on the box
function myfunc()
{
    ...
    // cheaking if player X won or not and after
    // that disabled all the order fields
    ...
    // cheaking of Player X finish
    // cheaking of player O starts ,is  player ) won or
    // not and after that disabled all other fields
    ...
    // cheaking  of player O finish
    // here ,cheaking about tie
    else if
...
// Here onwords ,function cheak turn of the player 
